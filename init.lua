  ...
  spec = {
    ...
    },
    {
      ...
      config = function(self)
        ...
        vim.keymap.set({ 'n', 'v' }, '<leader>K', invoke_with_opts { debug = true, progress_message_fn = progress_fn },
          { desc = 'Send current selection to LLM debug' })
        vim.keymap.set({ 'n', 'v' }, '<leader>k', invoke_with_opts { debug = false, progress_message_fn = progress_fn },
